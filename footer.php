...
<body>
  <div class="container-fluid ">
    <div class="row " style="padding-top: 2%;  color: white; background-color: #451f55;
" >
      <div class="col-sm-4" style="padding-left: 3%;">
       ...
       <p> If you’re interested in working<br>
        ...
        <i class="fa fa-envelope"  style="color: white" ></i> Email:vads@gmail.com
      ...
      <div class="col-sm-4" style="color: white; padding-left: 10%;">
        ...
        <a href="project.php.php" style="font-style: none; color: white;">Preject</a><br>
